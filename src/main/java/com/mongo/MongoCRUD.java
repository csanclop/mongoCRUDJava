...
public static void main(String[] args) throws UnknownHostException {
	...
	DBObject firstObject = BasicDBObjectBuilder.start().add("firstName", "christian").
			append("lastName", "lopez").get();
	...
	DBObject newDocument = BasicDBObjectBuilder.start().add("firstName", "christian").append("middleName", "sanchez").append("lastName", "lopez").get();
